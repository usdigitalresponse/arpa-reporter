...
const { capitalize, currency, ec, zip, zip4 } = require('../lib/format')
      ...
      switch (detailedEcCode) {
        ...
        case '2.10': {
          return [
            ...
            capitalize(record.content.Does_Project_Include_Capital_Expenditure__c),
      ...
      switch (detailedEcCode) {
        ...
        case '5.21': {
          return [
            ...
            record.content.Proj_Actual_Construction_Start_Date__c,
            record.content.Initiation_of_Operations_Date__c,
            capitalize(record.content.Is_project_designed_to_meet_100_mbps__c),
            record.content.Project_not_met_100_mbps_explanation__c,
            capitalize(record.content.Is_project_designed_to_exceed_100_mbps__c),
...
async function generateSubRecipient (records, periodId) {
  ...
  return subrecipients.map(subrecipient => {
    ...
    return [
      ...
      capitalize(record.Registered_in_Sam_gov__c),
